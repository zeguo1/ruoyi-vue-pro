...
public class ImChannelMaterialSaveReqVO {
    ...
    @Schema(description = "编号（修改时必填）；创建时可省略，不要编造编号；修改时必须提交已有记录编号", example = "1024", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.NOT_REQUIRED)
