...
public class ImChannelMessageController {
    ...
    public CommonResult<List<ImChannelMessagePullRespVO>> pullChannelMessageList(
            @io.swagger.v3.oas.annotations.Parameter(description = "消息增量游标，仅拉取编号大于该值的消息；初次可传 0") @RequestParam(value = "minId", defaultValue = "0") @PositiveOrZero(message = "minId 不能小于 0") Long minId,
            @io.swagger.v3.oas.annotations.Parameter(description = "本次最多拉取条数，默认 100，范围 1 到 200") @RequestParam(value = "size", defaultValue = "100")
