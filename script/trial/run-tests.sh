...
mvn -q -pl yudao-module-crm -am test \
  -Dtest=TrialSettingsHttpTest,TrialConnectorHttpIntegrationTest,TrialOrchestratorTest,TrialServiceAuthTest,TrialToolHttpIntegrationTest,TrialSmsVerificationTest,MgsTrialSmsSenderTest,TrialAuthorizationTest,MgsTrialOAuthGatewayTest,KnowdoResponseBoundTest,TrialBusinessIntegrationTest,TrialOperatorBootstrapTest,TrialLoginDeliveryTest,MgsTrialAccountIntegrationTest,TrialCorporateTenantIntegrationTest,TrialLocalJourneyIntegrationTest,TrialProcessRestartTest \
