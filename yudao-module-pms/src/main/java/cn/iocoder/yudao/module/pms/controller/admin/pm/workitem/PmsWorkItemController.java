...
public class PmsWorkItemController {
    ...
    public CommonResult<Boolean> updateWorkItem(@Validated(cn.iocoder.yudao.framework.common.validation.Update.class) @RequestBody PmsWorkItemSaveReqVO saveReqVO) {
