...
public class MesWmTransferController {
    ...
    public CommonResult<Boolean> updateTransfer(@Validated(cn.iocoder.yudao.framework.common.validation.Update.class) @RequestBody MesWmTransferSaveReqVO updateReqVO) {
