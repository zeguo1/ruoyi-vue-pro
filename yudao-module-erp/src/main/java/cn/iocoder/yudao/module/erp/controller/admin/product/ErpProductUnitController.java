...
public class ErpProductUnitController {
    ...
    public CommonResult<Boolean> updateProductUnit(@org.springframework.validation.annotation.Validated(cn.iocoder.yudao.framework.common.validation.Update.class) @RequestBody ErpProductUnitSaveReqVO updateReqVO) {
