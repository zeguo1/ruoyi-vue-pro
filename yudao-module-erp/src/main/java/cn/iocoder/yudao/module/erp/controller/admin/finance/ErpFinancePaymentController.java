...
public class ErpFinancePaymentController {
    ...
    public CommonResult<Boolean> updateFinancePaymentStatus(@io.swagger.v3.oas.annotations.Parameter(description = "已有付款单编号；从对应查询接口获取，不要编造") @RequestParam("id") Long id,
