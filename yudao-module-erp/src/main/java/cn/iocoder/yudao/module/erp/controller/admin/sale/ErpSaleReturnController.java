...
public class ErpSaleReturnController {
    ...
    public CommonResult<Boolean> updateSaleReturnStatus(@io.swagger.v3.oas.annotations.Parameter(description = "已有销售退货单编号；从对应查询接口获取，不要编造") @RequestParam("id") Long id,
