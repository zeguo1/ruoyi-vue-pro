...
public class ErpFinanceReceiptController {
    ...
    public CommonResult<Boolean> updateFinanceReceiptStatus(@io.swagger.v3.oas.annotations.Parameter(description = "已有收款单编号；从对应查询接口获取，不要编造") @RequestParam("id") Long id,
