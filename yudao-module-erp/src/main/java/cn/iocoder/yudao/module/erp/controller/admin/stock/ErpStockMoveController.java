...
public class ErpStockMoveController {
    ...
    public CommonResult<Boolean> updateStockMoveStatus(@io.swagger.v3.oas.annotations.Parameter(description = "已有库存调拨单编号；从对应查询接口获取，不要编造") @RequestParam("id") Long id,
