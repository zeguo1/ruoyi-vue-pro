...
public class ProductPropertyController {
    ...
    public CommonResult<Boolean> updateProperty(@Validated(cn.iocoder.yudao.framework.common.validation.Update.class) @RequestBody ProductPropertySaveReqVO updateReqVO) {
