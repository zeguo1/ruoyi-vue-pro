...
public class DictDataSaveReqVO {
    ...
    @Schema(description = "字典数据编号；创建时由后端生成，无需提交，传入值忽略；修改时必须提交已有记录编号", example = "1024", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.NOT_REQUIRED)
